...
$id = @file("id.txt") or $result = "파일을 읽을 수 없습니다.";
...
<html lang="en" dir="ltr">
  ...
  <input type="hidden" id="num" value="<?php echo$id[0]; ?>">
    ...
    <div id="all">
      <h2 id="Til">예매현황</h2>
        ...
        <div id="div1">
          ...
          <input type="button" value="돌아가기" id="back" onclick="location.href='mem_main.html'">
      </div>
        <script src="mem_Rev_manage.js" type="text/javascript"></script>
  </body>
</html>
